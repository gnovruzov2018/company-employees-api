...
namespace CodeMazeWebApi.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public IActionResult DeleteEmployeeForCompany(Guid companyId, Guid employeeId)
        {
            ...
            var employeeForCompany = _repository.Employee.GetEmployee(companyId, employeeId, trackChanges: false);
        ...
        public IActionResult UpdateEmployeeForCompany(Guid companyId, Guid employeeId, [FromBody] EmployeeForUpdateDto employee)
        {
            ...
            var employeeEntity = _repository.Employee.GetEmployee(companyId, employeeId, trackChanges: true);
